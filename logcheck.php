...
//Email
        if ($Send_Email == 1) {
            $subject = 'PPL Result : '.$IP_Connected.'';
...
//FTP
        if ($Ftp_Write == 1) {
            $file = fopen("rst/Result-By-Daril_Dixon." . $IP_Connected . ".txt", 'a');
